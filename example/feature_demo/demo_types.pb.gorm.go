...
import (
	...
	auth "github.com/kirinse/atlas-app-toolkit/auth"
...
func (m *TestTypes) ToORM(ctx context.Context) (TestTypesORM, error) {
	...
	if m.Uuid != nil {
		to.Uuid, err = _go.FromString(m.Uuid.Value)
		if err != nil {
			return to, err
		}
	} else {
...
func (m *TypeWithID) ToORM(ctx context.Context) (TypeWithIDORM, error) {
	...
	if m.DeletedAt != nil {
		var t time.Time
		if t, err = ptypes.Timestamp(m.DeletedAt); err != nil {
			return to, err
		}
		to.DeletedAt = &t
	}
...
func (m *TypeWithIDORM) ToPB(ctx context.Context) (TypeWithID, error) {
	...
	to.TagSizeTest = m.TagSizeTest
	if m.FloatField != nil {
		to.FloatField = &wrappers.FloatValue{Value: *m.FloatField}
	}
	if m.DoubleField != nil {
		to.DoubleField = &wrappers.DoubleValue{Value: *m.DoubleField}
	}
	if m.TimeOnly != "" {
		if to.TimeOnly, err = types.TimeOnlyByString(m.TimeOnly); err != nil {
			return to, err
	...
	if m.DeletedAt != nil {
		if to.DeletedAt, err = ptypes.TimestampProto(*m.DeletedAt); err != nil {
			return to, err
		}
	}
...
func (m *PrimaryUUIDType) ToORM(ctx context.Context) (PrimaryUUIDTypeORM, error) {
	...
	if m.Id != nil {
		tempUUID, uErr := _go.FromString(m.Id.Value)
		if uErr != nil {
			return to, uErr
		}
		to.Id = &tempUUID
